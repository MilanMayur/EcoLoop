...
export type DashboardRole = "vendor" | "recycler" | "driver" | "admin";
...
export type Status = "Pending" | "Batching" | "Assigned" | "In transit" | "Arrived" | "Collected" | "Completed" | "Cancelled" | "Available" | "On break" | "Accepted" | "Active" | "Delayed";
