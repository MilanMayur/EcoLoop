...
export const AI_PROMPTS: Record<AIAction, string> = {
  ...
  analyzeWasteImage: `${BASE}\nAnalyze the waste-bin image. Return the most likely waste type, visible fill level, possible contamination, and the type of authorized recycler that may be appropriate. Image analysis is an estimate; never claim an exact weight or guaranteed classification.`,
