...
export const api = {
  ...
  acceptPickup: pickupService.acceptPickup,
  startPickup: pickupService.startPickup,
  completePickup: pickupService.completePickup,
  uploadPickupImage: pickupService.uploadPickupImage,
